...
design-tokens/dist/tokens.ts + dist/css/tokens.css + dist/figma/tokens.json
    ...
    └─▶ dist/figma/tokens.json
            ...
            │
            ▼  figma/plugins/collider-token-sync (generated by pnpm figma:plugin:build
                   from @atomize-hq/figma-token-rail + figma/token-sync.config.json)
...
- Publish-plugin: `figma/plugins/collider-token-sync/` (generated; source is `@atomize-hq/figma-token-rail`)
